...
public class RoadTest {
    ...
    public void mainTowerIsDeadTest() {
        ...
        Entity enemy = new Enemy(0, "default_enemy", -1, 15, 100, 1, 0, 100, 100, 0);
    ...
    public void enemyDeathTest() {
        Entity enemy = new Enemy(1, "default_enemy", -1, 300, 30, 500, 250, 1, 0, 0);
        Entity ally = new Ally(2, "default_tower", -1, 15, 5, 500, 250, 1);
    ...
    public void allyReceivesDamageDoesNotDieTest() {
        Entity enemy = new Enemy(1, "default_enemy", -1, 300, 30, 500, 250, 1, 0, 0);
        Entity ally = new Ally(2, "default_tower", -1, 31, 5, 500, 250, 1);
        Road road = new Road(new Configuration(10, 10, 15,0), null);
        road.insert(enemy, 5);
        road.insert(ally, 5);
        road.update();
    ...
    public void enemyAttackCoolDownTest() {
        Entity enemy = new Enemy(1, "default_enemy", -1, 300, 30, 500, 250, 200, 0, 0);
        Entity ally = new Ally(2, "default_tower", -1, 40, 5, 500, 250, 200);
        Road road = new Road(new Configuration(10, 10, 15,0), null);
        road.insert(enemy, 5);
        road.insert(ally, 5);
        road.update();
