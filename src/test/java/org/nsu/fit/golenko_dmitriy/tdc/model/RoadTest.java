...
public class RoadTest {
    ...
    public void mainTowerIsDeadTest() {
        ...
        Entity enemy = new Enemy(0, -1, 15, 5000, 1, 0, 100, 100, 0);
        ...
        while (System.currentTimeMillis() < before + 2000) {
            isNotDead = road.update();
        }
        TestCase.assertFalse(isNotDead);
    }
    ...
    public void enemyDeathTest() {
        ...
        Road road = new Road(15);
        road.addEnemy(enemy, 5);
        road.addAlly(ally, 5);
        road.update();
